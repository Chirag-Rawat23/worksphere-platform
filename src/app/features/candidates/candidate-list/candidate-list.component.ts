...
export class CandidateListComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.departmentFilter.valueChanges.subscribe(departmentId => {
      this.applyDepartmentFilter(departmentId ? (typeof departmentId === 'string' ? parseInt(departmentId, 10) : departmentId) : null);
    });
  ...
  applyDepartmentFilter(departmentId: number | null | undefined): void {
    if (!departmentId) {
      this.loadCandidates();
      return;
    }
